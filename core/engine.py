...
class ScanEngine:
    ...
    FUZZ_SUFFIXES = [
        ...
        'Login', 'Logout', 'Register', 'Signin', 'Signout', 'Signup', 'ResetPwd', 'ForgotPwd', 'ResetPassword', 'ForgotPassword', 'ChangePassword', 'UpdatePassword', 'ModifyPassword',
    ...
    PATH_FRAGMENTS = [
        ...
        'troop', 'troops', 'troopInfo', 'unit', 'units', 'unitInfo', 'mission', 'missions', 'missionInfo', 'operation', 'operations', 'operationInfo', 'intel', 'intelligence',
        'equipment', 'equipmentInfo', 'weapons', 'weaponInfo', 'supplies', 'supplyInfo', 'logistics', 'logisticsInfo', 'communication', 'communications', 'communicationInfo', 'briefing', 'briefings',
        'player', 'players', 'playerInfo', 'avatar', 'avatars', 'avatarInfo', 'guild', 'guilds', 'guildInfo', 'clan', 'clans', 'clanInfo', 'team', 'teams', 'teamInfo',
        'quest', 'quests', 'questInfo', 'dungeon', 'dungeons', 'dungeonInfo', 'boss', 'bosses', 'bossInfo', 'match', 'matches', 'matchInfo', 'leaderboard', 'rank', 'ranks', 'rankInfo',
        'currency', 'currencies', 'currencyInfo', 'coin', 'coins', 'coinInfo', 'gem', 'gems', 'gemInfo', 'shop', 'shops', 'shopInfo', 'deal', 'deals', 'dealInfo', 'offer', 'offers', 'offerInfo',
        'health', 'healthInfo', 'healthCheck', 'ping', 'metrics', 'metric', 'metricInfo', 'performance', 'perf', 'cache', 'caches', 'security', 'secret', 'secrets'
    ]
